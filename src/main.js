...
var margin_map = {top: 20, right: 20, bottom: 20, left: 20},
    ...
    margin_county_bar = {top:20, right:10, bottom: 10, left:100},
...
var col_xs_width = d3.select('#width-setter').node().getBoundingClientRect().width,
    ...
    width_county_bar = (col_xs_width / 2) - margin_county_bar.left - margin_county_bar.right,
...
var height_world_map = (width_world_map / 2.5) - margin_map.top - margin_map.bottom,
    ...
    height_county_bar = (width_county_bar / 2) - margin_county_bar.top - margin_county_bar.bottom,
